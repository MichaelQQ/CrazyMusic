...
$(document).ready(function(){
    ...
    var key = NewGuid();
    //console.log(key);
    $("#qrcode").append("<img src='http://chart.apis.google.com/chart?chs=300x300&cht=qr&chl=http://192.168.1.103:8081/public/phone.html?key=" + key + "&choe=UTF-8' />");

    // NodeJS Server
    var nodejs_server = "192.168.1.103:8081";
    // 進行 connect
